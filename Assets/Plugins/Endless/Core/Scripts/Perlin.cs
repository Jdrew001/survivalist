...
namespace EndlessTerrain
{
    public static class Perlin
    {
        ...
        public static double Noise(Vector3d coord)
        {
        ...
        public static double Fbm(double x, double y, int octave)
        {
            return Fbm(new Vector2d(x, y), octave);
        }

        public static double Fbm(Vector3d coord, int octave)
        {
            double f = 0.0f;
            double w = 0.5f;
            for (var i = 0; i < octave; i++)
        ...
        public static double Fbm(double x, double y, double z, int octave)
        {
            return Fbm(new Vector3d(x, y, z), octave);
        }
    ...
    public struct Vector3d
    {
        ...
        public static Vector3d operator *(Vector3d v, double num) => new Vector3d(v.x * num, v.y * num, v.z * num);
